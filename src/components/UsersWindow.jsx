...
const UsersWindows = function () {
    ...
    const fetchUsers = async () => {
        try {
            const response = await fetch('https://aipluswebserver-vincenzocostantini-082c8784.koyeb.app/users/getall', {
                method: 'GET',
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch('https://aipluswebserver-vincenzocostantini-082c8784.koyeb.app/users', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + sessionStorage.getItem("token")
